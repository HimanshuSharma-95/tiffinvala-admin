...
export default function AddComboPage() {
  ...
  const isFormValid = () => {
    return form.name && form.price && rules.every((r) => r.category.length > 0);
  };
  ...
  const handleCreate = async (e: React.FormEvent) => {
    ...
    const payload = {
      ...
      rules: rules.map((rule) => ({
        ...
        label: rule.label,
        allowCustomSelection: rule.allowCustomSelection,
      })),
      options: {
    ...
    try {
      ...
      toast.success("Combo created! Now upload image.");
    } catch (error: any) {
  ...
  return (
    <div className="min-h-screen bg-white pb-10">
      ...
      <div className="flex items-center gap-3 px-4 py-4">
        ...
        <h1 className="text-lg font-bold text-[#1E2A3A]">Add Combo</h1>
      </div>
                ...
                <div className="flex items-center gap-2">
                  <button
                    ...
                    className={`w-10 h-5 rounded-full transition-colors ${
                      rule.allowCustomSelection ? "bg-[#F97316]" : "bg-gray-300"
                    }`}
                  >
                    <div
        ...
        <div className="flex items-center gap-3">
          <button
            ...
            className={`w-12 h-6 rounded-full transition-colors
                        ${form.fullyVeg ? "bg-green-500" : "bg-gray-300"}`}
          >
            <div
