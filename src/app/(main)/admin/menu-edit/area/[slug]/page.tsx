...
import { ArrowLeft, ChevronRight, UtensilsCrossed, PackagePlus } from 'lucide-react'
import {
    getAreaProducts,
    ...
    const handleComboToggle = async (
        ...
        try {
            ...
            if (combo.isLiveInArea) {
                await removeComboFromArea(
                    combo._id,
                    areaKey
                )
            } else {
                await makeComboLiveInArea(
                    combo._id,
                    areaKey
                )
            }
                ...
                >
                    <div className="flex items-center gap-3">
                        ...
                        <div className="text-left">
                            ...
                            <p className="text-xs text-gray-400">Manage items for {areaLabel}</p>
                        </div>
                    </div>
                ...
                >
                    <div className="flex items-center gap-3">
                        ...
                        <div className="text-left">
                            ...
                            <p className="text-xs text-gray-400">Manage combos for {areaLabel}</p>
                        </div>
                    </div>
                    <ChevronRight size={16} className="text-gray-400" />
                </button>
    ...
    if (view === 'items') return (
        <div className="min-h-screen bg-white pb-10">
            <div className="flex items-center gap-3 px-4 py-4">
                ...
                <div>
                    <h1 className="text-lg font-bold text-[#1E2A3A]">{areaLabel} Items</h1>
                    <p className="text-xs text-gray-400">Toggle to activate in this area</p>
                </div>
            </div>
...
">
                        ...
                        {comboGroups.map(combo => (
                            ...
                            <AreaComboCard
                                ...
                                combo={combo}
                                toggling={
                                    togglingId === combo._id
                                }
                                onToggle={() =>
                                    handleComboToggle(combo)
                                }
                            />
